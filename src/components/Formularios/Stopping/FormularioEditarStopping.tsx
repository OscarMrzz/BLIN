...
type Props = {
  ...
  refrescarTabla: () => void;
  stoppingAEditar: StoppingInterface;
};

export function FormularioEditarStopping({
  open,
  setOpen,
  refrescarTabla,
  stoppingAEditar,
  ...
  const [formData, setFormData] = React.useState({
    nombre_lugar: stoppingAEditar.nombre_lugar,
    cordenadas: stoppingAEditar.latitud + ", " + stoppingAEditar.longitud,
    id_rutas: stoppingAEditar.id_rutas,
  });
  ...
  const handleSubmit = async (evento: React.FormEvent) => {
    ...
    try {
      ...
      await updateParada(stoppingAEditar.id_paradas, {
